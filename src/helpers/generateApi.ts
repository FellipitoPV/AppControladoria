...
const api = axios.create({
  baseURL: 'https://gerarrelatorio-oxx6ulg2dq-uc.a.run.app',
  timeout: 300000, // 5 minutos (CloudConvert pode demorar)
...
export const generateWordDocument = async (
  ...
  try {
    ...
    const response = await api.post('/gerar-relatorio-ocorrencia', requestData, {
