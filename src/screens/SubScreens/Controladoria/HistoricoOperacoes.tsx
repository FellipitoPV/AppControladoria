  ...
  const abrirGoogleMaps = (cliente: string, endereco: string) => {
    ...
    Linking.canOpenURL(url).then(supported => {
      if (supported) {
        ...
        Linking.openURL(
          `https://www.google.com/maps/search/?api=1&query=${cliente}${enderecoFormatado}`,
        );
      }
    });
  };
          ...
          <View style={styles.headerLeft}>
            ...
            <Text style={styles.dataText}>
              ...
              {operacao.dataConclusao
                ? new Date(operacao.dataConclusao).toLocaleDateString('pt-BR')
                : 'Data não disponível'}
            </Text>
          </View>
        ...
        <View style={styles.cardContent}>
          ...
          <View style={styles.infoRow}>
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                abrirGoogleMaps(operacao.cliente, operacao.endereco)
              }>
              <View style={styles.iconLabel}>
                <MaterialIcons
                  name="location-on"
              ...
              <View style={styles.enderecoWrapper}>
                <Text style={styles.enderecoText}>{operacao.endereco}</Text>
                <MaterialIcons
                  name="map"
                  size={16}
                  color={customTheme.colors.primary}
              ...
              <View style={styles.itemsSection}>
                ...
                <View style={styles.itemsList}>
                  {operacao.containers.map((container, index) => (
                    <View key={index} style={styles.itemChip}>
                      <Text style={styles.itemText}>
                        {formatarTipoContainer(container)} (
                        {container.quantidade}x)
                      </Text>
                    </View>
                  ))}
                </View>
            ...
            <View style={styles.responsaveisList}>
              <View style={styles.responsavelItem}>
                ...
                <Text style={styles.responsavelNome}>
                  {operacao.responsavelOperacao?.nome || 'Não definido'}
                </Text>
              </View>
              ...
              <View style={styles.responsavelItem}>
                ...
                <Text style={styles.responsavelNome}>
                  {operacao.responsavelCarregamento?.nome || 'Não definido'}
                </Text>
              </View>
              ...
              <View style={styles.responsavelItem}>
                ...
                <Text style={styles.responsavelNome}>
                  {operacao.createdBy || 'Não definido'}
                </Text>
              </View>
            </View>
          </View>
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <TouchableOpacity
          ...
          />
          {(startDate || endDate) && <View style={styles.filterActiveDot} />}
        </TouchableOpacity>
      </View>
